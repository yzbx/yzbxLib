...
#exists($$bgslib){
LIBS +=-L$$bgsroot/debug/libbgs.so
#LIBS += -L/usr/local/lib -L$$bgsroot/build -L$$bgsroot/release -L$$bgsroot/debug
#LIBS +=$$bgslib \
...
#        release {
#                message (find release libbgs.so)
#                LIBS +=$$bgsroot/release/libbgs.so
#        }
	
#        debug {
#                message (find debug libbgs.so)
